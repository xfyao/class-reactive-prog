...
object Main {
  ...
  def main(args: Array[String]) {
    ...
    val timeOut: Future[String] = Future.delay(20 seconds).continue[String](_ =>"Server timeout!")
    ...
    val terminationRequested: Future[String] = {
      ...
      timeOut onComplete {
        case tryString => p.tryComplete(tryString)
      }
    ...
    terminationRequested onSuccess {
      case msg => println(msg);myServerSubscription.unsubscribe();println("Bye!")
    }
  }
